        ...
        <div class="box box-solid">
            <div class="box-header with-border">
                <div class="row float-end">
                    ...
                    <div id="print_expo_btns" class="col-md export float-end printer-hidden pl-2">
                        <div class="btn-group">
                            {if $print_button == true}
                            <button class="btn btn-sm btn-raised btn-secondary" type="button" data-bs-toggle="tooltip" title="Print" onClick="crud_print();">
                                <i class="fa fa-print crud-icon"></i>{t}Print{/t}
                            </button>
                            {/if}
                            {if $export_button == true}
                            <button class="btn btn-sm btn-raised btn-secondary dropdown-toggle" data-bs-toggle="tooltip" type="button" title="Export data in any format" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div id="title_btns" class="col-md-auto printer-hidden float-end pl-2">
                    ...
                    {/if}
                    {if $total_pages > 1}
                    <div id="search_btns" class="col-md printer-hidden float-end pl-2">
                    ...
                    {/if}
                    <div id="header_btns" class="col-md printer-hidden float-end pl-2">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form accept-charset="UTF-8" role="form" id="paginationForm" class="" action="ajax.php?choice=crud&crud={$choice}&action=list{$extra_url_args}" autocomplete="on" method="GET" style="display:inline-flex;">
                                ...
                                {if $admin == true}
                                <a class="btn btn-raised btn-sm btn-warning" href="" data-bs-toggle="modal" data-bs-target="#debugModal" title="{t}Debug Output{/t}" data-title="{t}Debug Output{/t}" >
                        ...
                        <div class="col-md-6 float-end">
                            {if $total_pages > 1}
                            <nav aria-label="Page" class="crud btn-group float-end">
