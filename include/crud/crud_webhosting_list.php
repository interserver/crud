...
function crud_webhosting_list() {
	...
	$crud = crud::init("select websites.website_id as service_id, website_masters.website_name, website_cost, website_hostname, website_status, services_name, website_comment, '' as website_extra
