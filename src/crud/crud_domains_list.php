...
function crud_domains_list()
{
    ...
    ->add_header_button(\MyAdmin\App::defaultTheme() == 'adminlte' ? \MyAdmin\App::link('index.php', 'choice=none.'.$settings['PREFIX'].'_order') : \MyAdmin\App::link('index.php', 'choice=none.buy_new_'.$settings['PREFIX']), _('Order'), 'primary', 'shopping-cart', _('Order').' '._($settings['TITLE']), 'client')
