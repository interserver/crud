...
FROM
	...
	dedicated_memory ON server_dedicated_memory = dedicated_memory.id
		LEFT JOIN
	dedicated_hd AS server_dedicated_hd1 ON server_dedicated_hd1 = dedicated_hd1.id
		LEFT JOIN
	dedicated_hd AS server_dedicated_hd2 ON server_dedicated_hd2 = dedicated_hd2.id
		LEFT JOIN
